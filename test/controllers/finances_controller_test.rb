...
class FinancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create finance" do
    assert_difference("Finance.count") do
      post finances_url, params: { finance: { account_type: @finance.account_type, bank_name: @finance.bank_name, finance_type: @finance.finance_type, will_id: @finance.will_id } }
    end
  ...
  test "should update finance" do
    patch finance_url(@finance), params: { finance: { account_type: @finance.account_type, bank_name: @finance.bank_name, finance_type: @finance.finance_type, will_id: @finance.will_id } }
